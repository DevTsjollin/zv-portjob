...
cfg.framework = 'qbcore' -- Choose between qbcore, esx, standalone | Modify server/functions.lua if you are running a custom/standalone framework
cfg.interaction = 'qb-target' -- Choose between qb-target

cfg.BailPrice = 250

cfg.Locations = {
    ["main"] = {
        label       = "Harbour", -- Includes where people has to collect ther payslip
        coords      = vector4(-8.95, -2535.76, 7.39, 114.24),
        sprite      = 615,
        display     = 4,
        scale       = 1.0,
        colour      = 31
    ...
    ["handler"] = {
        label       = "Handler Storage",
        coords      = vector4(-37.98, -2422.22, 6.0, 358.1),
        sprite      = 473,
        display     = 4,
        scale       = 0.6,
        colour      = 1
